...
# ###########################################
# VERSION 1.0
# DATE CREATE: 4th OCT., 2017
# UPDATE HISTORY
# * Basic function replicatetd from edge_market_tracer_1_1
# ##########################################
...
### LOAD last emtSupervisedSpan counted rows from target asset class price history
for i in range(emtPriceLen - emtSupervisedSpan, emtPriceLen, emtSupervisedSpan):
    ...
    ### LOAD PRICE DATA : DURATION = LEARNING PERIOD
    sPriceDF = emtPriceDF[i:i + emtSupervisedSpan]
    ...
    ### TEST MODEL
    ### TEST MODEL PORTION should be moved into BAU PROCESSING 
...
### *** END OF MAIN LOOP: PROCESS INITIAL STUDY:THIS IS STARTING POINT OF BAU 
